...
class TC_Drone_App(QMainWindow):
    ...
    def movement_tab(self):
        ...
        #temp button used to check if mission functions work)
        self.temp_button = QPushButton("temp button")
        ...
        policy_up_temp = self.temp_button.sizePolicy()
        policy_up_temp.setVerticalPolicy(QSizePolicy.Policy.Expanding)
        self.temp_button.setSizePolicy(policy_up_temp)
        self.temp_button.setMinimumHeight(60)
        ...
        self.mission_layout.addWidget(self.temp_button)
...
#Overall UI
    ...
    @asyncSlot()
    async def temp(self):
        await self.mission.upload_mission_plan()
